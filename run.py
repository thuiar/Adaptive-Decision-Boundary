...
class ModelManager:
    ...
    def evaluation(self, args, data, mode="eval"):
        ...
        if mode == 'eval':
            ...
            results['Overall'] = f1_score(y_true, y_pred, average="macro")
    ...
    def save_results(self, args):
        ...
        var = [args.task_name, args.method, args.known_cls_ratio, args.labeled_ratio, args.seed]
        names = ['task_name', 'method', 'known_cls_ratio', 'labeled_ratio', 'seed', 'lr']
